...
INSERT INTO `sys_role` (`id`, `sort_order`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `code`,
                        `name`, `description`, `status`, `is_default`, `fix_role`)
VALUES (1, 1, 'admin', '2024-10-25 15:07:55', 'admin', '2024-10-25 15:08:05', '1', 'ROLE_ADMIN', '管理员',
        '拥有所有权限', 1, 0, 1);
INSERT INTO `sys_role` (`id`, `sort_order`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `code`,
                        `name`, `description`, `status`, `is_default`, `fix_role`)
VALUES (2, 2, 'admin', '2024-10-25 15:08:15', 'admin', '2024-10-25 15:08:07', '1', 'ROLE_NORMAL', '普通用户',
        '没有任何权限', 1, 1, 1);
...
INSERT INTO `sys_user` (`id`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `username`,
                        `password`, `nickname`, `email`, `phone`, `enabled`, `account_non_locked`,
                        `credentials_non_expired`, `account_non_expired`, `dept_id`)
VALUES (1, 'admin', '2024-10-24 07:25:34', 'admin', '2024-10-26 03:49:00', '1', 'admin',
        '$2a$10$7GBeWjeLbS1OUOFl18nvMeiww0cAtVQRCnNOQJBVgzoJX.KMaezSy', '程益祥', '1574641450@qq.com', '13235423290', 1,
        1, 1, 1, 1);
